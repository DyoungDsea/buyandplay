                            ...
                            <div class="sec-box">
                                ...
                                <div class="contents"  >
                                    ...
                                    <tbody id="myDIV">
                                        ...
                                        $sqls =$conn->query("SELECT * FROM  `dpool_code`  WHERE dresult = 'lost' AND pstatus = 'Approved' ORDER BY dstart_time ");
                                        $total_records =$sqls->num_rows;
                                        $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                        $start_from = ($page_no - 1) * $total_records_per_page;

                                        $v =$conn->query("SELECT * FROM  `dpool_code`  WHERE dresult = 'lost' AND pstatus = 'Approved' ORDER BY dstart_time   LIMIT $start_from, $total_records_per_page");
                                        if($v->num_rows>0){
