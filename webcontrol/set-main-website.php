                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Manage Buy & Bet Website</h2>
                                </header>
                                <div class="contents"  >
                                    ...
                                    <section class="boxpadding">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php 
                                                ...
                                                $c = $conn->query("SELECT * FROM `dwebsite_main` ");
...
<?php
    ...
    $x = $conn->query("SELECT * FROM `dwebsite_main`");
    if($x->num_rows>0):
    ...
    <div class="modal fade" id="max<?php echo $xx['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="addressModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document" style="max-width:550px;">
            <div class="modal-content">
                <form action="manage-odd-update" method="post">
                    <div class="modal-header">
                        <h3 class="modal-title" id="addressModalLabel">Update Website</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div><!-- End .modal-header -->
                    <div class="modal-body">
                            <div class="form-group">
                                <label for="cat">Website </label>
                                <input type="text" name="cat" id="cat"  value="<?php echo $xx['dname']; ?>" required placeholder="Enter Website" class="form-control">
                                <input type="hidden" name="hid"  value="<?php echo $xx['id']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="cat2">Email</label>
                                <input type="text" name="catf" id="cat2"  value="<?php echo $xx['demail']; ?>" required placeholder="Enter Name" class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="cat2">Address</label>
                                <textarea type="text" name="catftt" id="cat2sx"  required placeholder="Enter Address" class="form-control"> <?php echo $xx['daddress']; ?></textarea>
                            </div>

                    </div><!-- End .modal-body -->
                    <div class="modal-footer">
                    <button type="button" class="btn btn-link btn-sm" data-dismiss="modal">Close</button>
                        <button type="submit" name="webupmain" class="btn btn-primary btn-sm">Update</button>
                    </div><!-- End .modal-footer -->
                </form>
            </div><!-- End .modal-content -->
        </div><!-- End .modal-dialog -->
