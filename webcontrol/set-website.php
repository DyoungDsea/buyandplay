                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Manage Booking Website</h2>
                                </header>
                                <div class="contents"  >
                                    ...
                                    <section class="boxpadding">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php 
                                                ...
                                                $c = $conn->query("SELECT * FROM `dweb_name` ORDER BY name ");
                                                ...
                                                if($c->num_rows>0){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <a class="btn btn-sm btn-danger " id="web" web="<?php echo $r['id']; ?>" href="#"><i class="fa fa-trash"></i> Delete </a>
                                                        </td>
                                                    </tr>
                                                    <?php endwhile;  }else{
                                                        echo '
...
<?php
    ...
    $x = $conn->query("SELECT * FROM `dweb_name` ORDER BY name");
    if($x->num_rows>0):
            ...
            <div class="modal-content">
                <form action="manage-odd-update" method="post">
                    ...
                    <div class="modal-body">
                            <div class="form-group">
                                <label for="cat">Website</label>
                                <input type="text" name="cat" id="cat"  value="<?php echo $xx['dwebsite']; ?>" required placeholder="Enter Website" class="form-control">
                                <input type="hidden" name="hid"  value="<?php echo $xx['id']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="cat2">Name</label>
                                <input type="text" name="catf" id="cat2"  value="<?php echo $xx['name']; ?>" required placeholder="Enter Name" class="form-control">
                            </div>

                    </div><!-- End .modal-body -->
                    <div class="modal-footer">
                    <button type="button" class="btn btn-link btn-sm" data-dismiss="modal">Close</button>
                        <button type="submit" name="webup" class="btn btn-primary btn-sm">Update</button>
                    </div><!-- End .modal-footer -->
                </form>
            </div><!-- End .modal-content -->
        </div><!-- End .modal-dialog -->
