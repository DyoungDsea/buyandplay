...
mysqli_query($conn, "insert into table_name set transid='$transid', dname='$dname'") or die(mysqli_error($conn));
...
mysqli_query($conn, "update table_name set src='$picid' where transid='$transid'");
}   
...
include("image_maker.php");
mysqli_query($conn, "update table_name set src2='$picid' where transid='$transid'");
}    
