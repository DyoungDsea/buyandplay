<?php 
    ...
    if($user['dposition'] !="administrator"){
        $level = $user['dprivileges'];
            ...
            if(!in_array('Ranking Fees', $exploded)){
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Manage Ranking</h2>
                                </header>
                                <div class="contents"  >
                                    ...
                                    <section class="boxpadding">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php 
                                                ...
                                                $c = $conn->query("SELECT * FROM `ranking` WHERE dstar !=0 ORDER BY dstar ");
...
<?php
    ...
    $x = $conn->query("SELECT * FROM `ranking` ORDER BY dprice");
    if($x->num_rows>0):
    ...
    <div class="modal fade" id="max<?php echo $xx['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="addressModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document" style="max-width:550px;">
            <div class="modal-content">
                <form action="manage-ranking-update" method="post">
                    <div class="modal-header">
                        <h3 class="modal-title" id="addressModalLabel">Update Ranking</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div><!-- End .modal-header -->
                    <div class="modal-body">
                            <div class="form-group">
                                <label for="cat">Ranking Star</label>
                                <input type="text" name="cat" disabled id="cat" value="<?php echo $xx['dstar']; ?>" required placeholder="Enter Ranking Number e.g 5" class="form-control">
                                <input type="hidden" name="hid"  value="<?php echo $xx['dstar_id']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="cat2">Ranking Fees</label>
                                <input type="text" name="catf" id="cat2"  value="<?php echo $xx['dprice']; ?>" required placeholder="Enter Ranking Fees" class="form-control">
                            </div>
