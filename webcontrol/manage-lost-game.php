                            ...
                            <div class="sec-box">
                                ...
                                <div class="contents"  >
                                    ...
                                    <tbody id="myDIV">
                                        ...
                                        $sqls =$conn->query("SELECT * FROM `dbooking_code` INNER JOIN `dgame_categories` ON dgame_categories.category_id = dbooking_code.dodd WHERE dbooking_code.dresult = 'lost'");
                                        $total_records =$sqls->num_rows;
                                        $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                        $start_from = ($page_no - 1) * $total_records_per_page;
                                        $v =$conn->query("SELECT * FROM `dbooking_code` INNER JOIN `dgame_categories` ON dgame_categories.category_id = dbooking_code.dodd WHERE dbooking_code.dresult = 'lost' ORDER BY dbooking_code.id DESC LIMIT $start_from, $total_records_per_page");
                                        if($v->num_rows>0){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $r['dresult'] ?> <img style="width:30%" src="../assets/images/close.png" alt="site-logo"></td>
...
<?php
    ...
    $x = $conn->query("SELECT * FROM `dbooking_code` INNER JOIN `dgame_categories` ON dgame_categories.category_id = dbooking_code.dodd WHERE dbooking_code.dresult = 'lost' ORDER BY dbooking_code.id DESC LIMIT $start_from, $total_records_per_page");
    if($x->num_rows>0):
