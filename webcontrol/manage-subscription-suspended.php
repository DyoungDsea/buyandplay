                    ...
                    if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Manage Suspended Tipsters</h2>
                                </header>
                                <div class="contents"  >
                                    ...
                                    <section class="boxpadding">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php 
                                                ...
                                                $sqls=$conn->query("SELECT * FROM `dcategory_subscriptions` WHERE status='suspended' ORDER BY dcategory");
                                                $total_records =$sqls->num_rows;
                                                $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                                $start_from = ($page_no - 1) * $total_records_per_page;
                                                // $c = $conn->query("SELECT * FROM `dcategory_subscriptions` WHERE dstatus='suspended' ORDER BY dcategory LIMIT $start_from, $total_records_per_page");

                                                $c = $conn->query("SELECT * FROM `dcategory_subscriptions` INNER JOIN `dgame_categories` ON    dgame_categories.category_id = dcategory_subscriptions.dgame_cat_id WHERE dcategory_subscriptions.status='suspended'");
                                                ...
                                                if($c->num_rows>0){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input type="hidden" value="<?php echo basename($_SERVER["REQUEST_URI"]); ?>" id='uri'>
                                                            <a class="btn btn-sm btn-primary" href="#" id="apprtipster" cat="<?php echo $r['dcategory_id']; ?>" ><i class="fa fa-check "></i> Active </a>
