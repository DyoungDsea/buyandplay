                    ...
                    if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading"> Pending Fund Request</h2>
                                </header>
                                <div class="contents"  >
                                    ...
                                    <section class="boxpadding">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php 
                                                ...
                                                $sqls=$conn->query("SELECT * FROM `funding_request` WHERE dstatus='pending' ORDER BY id");
                                                $total_records =$sqls->num_rows;
                                                $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                                $start_from = ($page_no - 1) * $total_records_per_page;

                                                $c = $conn->query("SELECT * FROM `funding_request` INNER JOIN `members_register` ON    funding_request.userid = members_register.userid  WHERE funding_request.dstatus='pending' ORDER BY funding_request.pdate DESC");
                                                ...
                                                if($c->num_rows>0){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <div class="btn-group" >
                                                            ...
                                                            <li><a class="nav-link" href="#" id="paymentFund" email="<?php echo $r['demail']; ?>" user="<?php echo $r['userid']; ?>" withs="<?php echo $r['req_id']; ?>" amount="<?php echo $r['damount']; ?>" ><i class="fa fa-check "></i> Appove</a></li>
                                                            <div class="divider"></div>
                                                            <li><a class="nav-link" href="#" id="noPayFund" email="<?php echo $r['demail']; ?>" user="<?php echo $r['userid']; ?>" withs="<?php echo $r['req_id']; ?>" amount="<?php echo $r['damount']; ?>"><i class="fa fa-times"></i> Cancel</a></li>
                                                            </ul>
                                                        </div>
                                                        </div>
                                                        </td>
