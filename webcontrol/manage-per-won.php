                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Percentage of game won</h2>
                                </header>
                                <div class="contents"  >
                                    ...
                                    <section class="boxpadding">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php 
                                                ...
                                                $c = $conn->query("SELECT * FROM `dpercentage`");
                                                ...
                                                if($c->num_rows>0){
                                                    ...
                                                    <tr>
                                                        <td><?php echo $num++; ?></td>
                                                        <td><?php echo $r['dadmin']; ?></td>
                                                        <td><?php echo $r['dusers']; ?></td>
                                                        <td>
                                                        <a class="btn-sm btn btn-primary" data-toggle="modal" data-target="#max<?php echo $r['id']; ?>" href="#"><i class="fa fa-edit"></i> Edit </a>
                                                        </td>
                                                    </tr>
                                                    <?php endwhile;  }else{
                                                        echo '
...
<?php
    ...
    $x = $conn->query("SELECT * FROM `dpercentage` ");
    if($x->num_rows>0):
        ...
        <div class="modal-dialog" role="document" style="max-width:550px;">
            <div class="modal-content">
                <form action="manage-odd-update" method="post">
                    <div class="modal-header">
                        <h3 class="modal-title" id="addressModalLabel">Update Manage Percentage won</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div><!-- End .modal-header -->
                    <div class="modal-body">
                            <div class="form-group">
                                <label for="cat">Admin percentage</label>
                                <input type="text" name="cat" id="cat" value="<?php echo $xx['dadmin']; ?>" required placeholder="Enter Admin percentage" class="form-control">
                                <input type="hidden" name="hid"  value="<?php echo $xx['id']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="cat2">Tipster percentage</label>
                                <input type="text" name="catf" id="cat2"  value="<?php echo $xx['dusers']; ?>" required placeholder="Enter Tipster percentage" class="form-control">
                            </div>

                    </div><!-- End .modal-body -->
                    <div class="modal-footer">
                    <button type="button" class="btn btn-link btn-sm" data-dismiss="modal">Cancel</button>
                        <button type="submit" name="tip" class="btn btn-primary btn-sm">Update</button>
                    </div><!-- End .modal-footer -->
                </form>
            </div><!-- End .modal-content -->
        </div><!-- End .modal-dialog -->
