<?php 
    ...
    if($user['dposition'] !="administrator"){
        $level = $user['dprivileges'];
            ...
            if(!in_array('Withdrawal Request', $exploded)){
...
<title>Pending Withdrawal Request : Bet and Buy</title>
                    ...
                    if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Pending Withdrawal Request</h2>
                                </header>
                                <div class="contents"  >
                                    ...
                                    <section class="boxpadding">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php 
                                                ...
                                                $c = $conn->query("SELECT * FROM `dwithdrawal_history` INNER JOIN `members_register` ON    dwithdrawal_history.user_id = members_register.userid   WHERE dwithdrawal_history.withdrawal_status='pending' ORDER BY dwithdrawal_history.pdate DESC");
                                                ...
                                                if($c->num_rows>0){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <div class="btn-group" >
                                                            ...
                                                            <li><a class="nav-link" href="#" id="payment" email="<?php echo $r['demail']; ?>" user="<?php echo $r['userid']; ?>" withs="<?php echo $r['withdrawal_id']; ?>" ><i class="fa fa-check "></i> Appove</a></li>
