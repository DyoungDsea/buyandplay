                    ...
                    if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Manage Pending Request</h2>
                                </header>
                                <div class="contents"  >
                                    ...
                                    <section class="boxpadding">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php 
                                                ...
                                                $sqls=$conn->query("SELECT * FROM `dwithdrawal_history` WHERE withdrawal_status='pending' ORDER BY id");
                                                ...
                                                $c = $conn->query("SELECT * FROM `dwithdrawal_history` INNER JOIN `admin_accounts` ON    dwithdrawal_history.user_id = admin_accounts.userid   WHERE dwithdrawal_history.withdrawal_status='pending' ORDER BY dwithdrawal_history.pdate DESC");
                                                ...
                                                if($c->num_rows>0){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <div class="btn-group" >
                                                            ...
                                                            <li><a class="nav-link" href="#" id="payments" user="<?php echo $r['userid']; ?>" withs="<?php echo $r['withdrawal_id']; ?>" ><i class="fa fa-check "></i> Appove</a></li>
                                                            <div class="divider"></div>
                                                            <li><a class="nav-link" href="#" id="noPays" user="<?php echo $r['userid']; ?>" withs="<?php echo $r['withdrawal_id']; ?>" ><i class="fa fa-times"></i> Cancel</a></li>
                                                            </ul>
                                                        </div>
                                                        </div>
                                                        </td>
