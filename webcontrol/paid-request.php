                    ...
                    if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading"> Paid Withdrawal Request</h2>
                                </header>
                                <div class="contents"  >
                                    ...
                                    <section class="boxpadding">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php 
                                                ...
                                                $c = $conn->query("SELECT * FROM `dwithdrawal_history` INNER JOIN `admin_accounts` ON    dwithdrawal_history.user_id = admin_accounts.userid   WHERE dwithdrawal_history.withdrawal_status='paid' ORDER BY dwithdrawal_history.pdate DESC");
