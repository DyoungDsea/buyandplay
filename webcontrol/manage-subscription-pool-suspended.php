                    ...
                    if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Manage Suspended Pools Tipster</h2>
                                </header>
                                <div class="contents"  >
                                    ...
                                    <section class="boxpadding">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php 
                                                ...
                                                $sqls=$conn->query("SELECT * FROM `dcategory_subscriptions` INNER JOIN `dpools` ON dpools.dcategory_ids = dcategory_subscriptions.dgame_cat_id WHERE dcategory_subscriptions.status='suspended'");
                                                $total_records =$sqls->num_rows;
                                                $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                                $start_from = ($page_no - 1) * $total_records_per_page;

                                                $c = $conn->query("SELECT * FROM `dcategory_subscriptions` INNER JOIN `dpools` ON dpools.dcategory_ids = dcategory_subscriptions.dgame_cat_id WHERE dcategory_subscriptions.status='suspended' ORDER BY dcategory_subscriptions.ddate LIMIT $total_records_per_page");
                                                ...
                                                if($c->num_rows>0){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <a class="btn-sm btn-primary btn" href="#" id="appr" cart_id="<?php echo $r['dgame_cat_id']; ?>" user="<?php echo $r['userid']; ?>" cat="<?php echo $r['dcategory_id']; ?>"><i class="fa fa-check "></i> Active </a>
                                                        </td>
                                                    </tr>
                                                    <?php endwhile;  }else{
                                                        echo '
