...
<title>Manage Sport Bet Odd : Bet and Buy</title>
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <?php 
                                 ...
                                 $cd = $conn->query("SELECT * FROM `dgeneral_booking` WHERE dstatus !='Free' AND dcat_id='$cat_id' GROUP BY dcat_id ORDER BY dcategory")->fetch_assoc();
                                 $cate = $cd['dcategory'];
                                 ?>
                                ...
                                <div class="contents"  >
                                    ...
                                    $cat_id = clean($_GET['odd_id']);
                                                $c = $conn->query("SELECT * FROM `dgeneral_booking` WHERE dcat_id='$cat_id' AND dstatus !='Free'");
...
<?php
    ...
    $x = $conn->query("SELECT * FROM `dgeneral_booking` WHERE dcat_id='$cat_id' AND dstatus !='Free'");
    if($x->num_rows>0):
            ...
            <div class="modal-content">
                <form action="manage-odd-update" method="post">
                    ...
                    <button type="button" class="btn btn-link btn-sm" data-dismiss="modal">Close</button>
                        <button type="submit" name="ten" class="btn btn-primary btn-sm">Update</button>
                    </div><!-- End .modal-footer -->
                </form>
            </div><!-- End .modal-content -->
        </div><!-- End .modal-dialog -->
