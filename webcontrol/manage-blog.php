                    ...
                    if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Manage Blog</h2>
                                </header>
                                <div class="contents"  >
                                    ...
                                    <section class="boxpadding">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php 
                                                ...
                                                $c = $conn->query("SELECT * FROM `blog` ORDER BY id DESC LIMIT $start_from, $total_records_per_page");
                                                ...
                                                if($c->num_rows>0){
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td>
                                                           <?php
                                                           if(!empty($r['img'])){?>
                                                            <img style="height:100px;width:150px;" src="images/<?php echo $r['img']; ?>">
                                                         <?php  }
                                                           ?>
                                                           
                                                        </td>
                                                        <td><?php echo $r['title']; ?></td>
                                                        <td style="word-wrap:break-word;"><?php echo substr(remove_tags($r['content']),0,50); ?>....</td>
                                                        ...
                                                        <div class="btn-group" >
                                                            ...
                                                            <li><a class=" " data-toggle="modal" data-target="#max<?php echo $r['id']; ?>" href="#"><i class="fa fa-edit"></i> Edit Blog</a></li>
                                                            <li><a class="" href="#" id="blogDelete" img="images/<?php echo $r['img']; ?>.jpg" blog="<?php echo $r['id']; ?>" ><i class="fa fa-trash"></i> Delete</a></li>
                                                            </ul>
                                                        </div>
                                                        </div>
                                                        </td>
        ...
        <div class="modal-dialog" role="document" style="max-width:550px;">
            <div class="modal-content">
                <form action="blog-update" method="post" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h3 class="modal-title" id="addressModalLabel">Update Blog</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div><!-- End .modal-header -->
            ...
            <input type="hidden" name="oldpic" value="<?php echo $xx['img']?>">

                    <div class="row">
    <div class="form-group col-md-12">
      <label for="inputEmail4">Title</label>
      <input type="text" class="form-control" value="<?php echo  $xx['title'];?>" name="title" id="inputEmail4" placeholder=" Title" >
