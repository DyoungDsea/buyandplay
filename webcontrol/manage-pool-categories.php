                    ...
                    if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Manage Pools Categories</h2>
                                </header>
                                <div class="contents"  >
                                    ...
                                    <section class="boxpadding">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php 
                                                ...
                                                $sqls=$conn->query("SELECT * FROM `dpools` WHERE dstatus='active' ORDER BY dpool ");
                                                $total_records =$sqls->num_rows;
                                                $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                                $start_from = ($page_no - 1) * $total_records_per_page;
                                                $c = $conn->query("SELECT * FROM `dpools` WHERE dstatus='active' ORDER BY dpool  DESC LIMIT $start_from, $total_records_per_page");
                                                ...
                                                if($c->num_rows>0){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input type="hidden" value="<?php echo $r['dcategory_ids']; ?>" id='referral<?php echo $r['id']; ?>'>
                                                        <div class="btn-group">
                                                        <div class="btn-group" >
                                                            ...
                                                            <li><a class="" href="#" id="catDeletep" cat="<?php echo $r['dcategory_ids']; ?>" ><i class="fa fa-trash"></i> Delete</a></li>
                                                            </ul>
                                                        </div>
                                                        </div>
                                                        </td>
            ...
            <div class="modal-content">
                <form action="category" method="post">
                    ...
                    <button type="button" class="btn btn-link btn-sm" data-dismiss="modal">Close</button>
                        <button type="submit" name="pools" class="btn btn-primary btn-sm">Submit</button>
...
<?php
    ...
    $x = $conn->query("SELECT * FROM `dpools` WHERE dstatus='active' ORDER BY dpool");
    if($x->num_rows>0):
            ...
            <div class="modal-content">
                <form action="category-update" method="post">
                    ...
                    <div class="modal-body">
                            <div class="form-group">
                                <label for="cat">Category</label>
                                <input type="text" name="cat" id="cat" value="<?php echo $xx['dpool']; ?>" required placeholder="Enter Category" class="form-control">
                                <input type="hidden" name="hid"  value="<?php echo $xx['dcategory_ids']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="cat2">Category Fees</label>
                    ...
                    <div class="modal-footer">
                    <button type="button" class="btn btn-link btn-sm" data-dismiss="modal">Close</button>
                        <button type="submit" name="pool" class="btn btn-primary btn-sm">Update</button>
                    </div><!-- End .modal-footer -->
                </form>
            </div><!-- End .modal-content -->
        </div><!-- End .modal-dialog -->
