      ...
      if($x->num_rows>0):            
        while($r=$x->fetch_assoc()):
            ...
            if($q['dstatus'] =='gold' AND $q['dcat_id']==$r['dodd']){
                    ...
                    <div class="modal-body">
                      ...
                      <table class="table-bordered">
                          ...
                          <tr>
                            ...
                            <td>
                            <a href="http://<?php echo $r['dwebsite1']; ?>" target="_blank"  class="btn btn-sm btn-primary"><?php echo ucfirst($r['dweb_name1']); ?> </a>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td>
                            <a href="http://<?php echo $r['dwebsite2']; ?>" target="_blank"  class="btn btn-sm btn-primary"><?php echo ucfirst($r['dweb_name2']); ?> </a>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td>
                            <a href="http://<?php echo $r['dwebsite3']; ?>" target="_blank"  class="btn btn-sm btn-primary"><?php echo ucfirst($r['dweb_name3']); ?> </a>
                            </td>
                          </tr>
                ...
                $amounts = (Float)$ra['dprice'];
                if($r['dtotal'] == $won ):?>
            <div class="modal fade" id="buy<?php echo $r['booking_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">View Free</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
