...
<body>
 ...
 <?php include 'header.php'; ?>
  ...
  <section class="blog-details-section  padding-top-95x " style="margin:40px 0;">
                    ...
                    <!-- widget end -->
                        <div class="widget widget-categories">                     
                          <ul>
                            ...
                            <hr style="margin-top:-1px; margin-bottom:4px;">
                            <li class="active-section"><a href="four-star-game" style="font-size:20px;">4+ Odds</a></li>
                            <hr style="margin-top:-1px; margin-bottom:4px;">
