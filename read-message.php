...
<body>
  ...
  <section class="blog-details-section mt-4">
...
<div class="row">
        <div class="col-md-2"></div>
            <div class="table-responsiver col-md-8">
                        ...
                        $v =$conn->query("SELECT * FROM `dmessaging` WHERE transid='$transid' GROUP BY transid");
                        $c = $conn->query("UPDATE dmessaging SET dstatus='read' WHERE transid='$transid'");
                        ...
                        $rv = $xv->fetch_assoc();
                             ?>
                            <br>
                            <form class="cmn-form login-form" method="POST" action="read-process">                            
                            <input type="hidden" name="trans" id="" value="<?php echo $transid ?>">
                            <input type="hidden" name="subject" id="" value="<?php echo $rv['dsubject'] ?>">
                            
                            <div class="frm-group">
                            <textarea name="sms"  >Re:</textarea>
                            </div>
                            <div class="frm-group">
                            <button type="submit" name="reply" class="submit-btn"> <i class="fa fa-share"></i> Reply</button>
                            </div>
                        </form>
