...
<head>
  ...
  <title>Buy and Bet | All NAP Tips</title>
...
<body>
    ...
    <div class="containerfluid">
      <div class="row justify-content-center bg-primaryz" style="padding:40px">
       ...
       <div class="row bg-successj">
                    ...
                    <!-- widget end -->
                        <div class="widget widget-categories">                     
                          ...
                          <li class="active-sectionb" ><a href="all-tips" style="font-size:20px;">Free</a></li>              
                            ...
                            <hr style="margin-top:-1px; margin-bottom:4px;">
                            <li class="active-section"><a href="nap-pool" style="font-size:20px;">NAP(Pool) </a></li>
                            <hr style="margin-top:-1px; margin-bottom:4px;">
        ...
        <li class="nav-item">
          <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">NAP 3 star</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">NAP 4 star</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">NAP 5 star</a>
        </li>
        ...
        <div class="tab-content" style="width:100%" id="pills-tabContent">
            <div class="tab-pane fade show active container-fliud"  id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <?php require 'three-star-pool.php'; ?>
            </div>


            <div class="tab-pane fade  container-fliud"  id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
            <?php require 'four-star-pool.php'; ?>
            </div>

            <div class="tab-pane fade  container-fliud"  id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
            <?php require 'five-star-pool.php'; ?>
            </div>
 ...
 <?php include 'footer.php'; ?>
  ...
  <?php 
    ...
    include 'three-pool-modal.php';
    include 'four-pool-modal.php';
    include 'five-pool-modal.php';
    }
