<?php
                            ...
                            $cot = $conn->query("SELECT * FROM `dstar_rating` INNER JOIN `dgame_categories` ON dstar_rating.dcategory_id= dgame_categories.category_id WHERE dgame_categories.category_id='$cat' AND dstar_rating.duser_id='$id' AND dgame_categories.dstatus='active' ");
                            if($cot->num_rows > 0){
                            //test the star
